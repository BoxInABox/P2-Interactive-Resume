...
var HTMLskillsStart = '<h3 id="skills-h3" class="blue-text">Skills at a Glance:</h3><ul id="skills" class="flex-box-column"></ul>';
...
var HTMLonlineClasses = '<h3 class="blue-text">Online Classes</h3>';
